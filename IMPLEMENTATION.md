...
**Перед началом прочитайте:** [`INPUT_HANDLING_STANDARD.md`](./INPUT_HANDLING_STANDARD.md) — стандарт единой точки приёма пользовательского ввода (маркировка элементов, жесты, интерпретатор, тестовый хук).
